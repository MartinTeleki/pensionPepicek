      ...
      <div>
        ...
        <div className={styles.layout}>
          ...
          <div className={styles.whiteSection}>
            <section className={styles.welcomeSection}>
              <p>
                Penzion u Pepíčka je ideálním místem pro rodiny s dětmi, pro
                které je k dispozici dětské hřiště se skluzavkou, houpačkou,
          ...
          <div className={styles.greySection}>
            <section className={styles.welcomeSection2}>
              <p>
                Nově vybudovaný prostor restaurace/baru s výčepem nabízí
                příjemné posezení pod jednou střechou nejenom s přáteli.
              </p>
          ...
          <div className={styles.whiteSection}>
            <section className={styles.welcomeSection}>
              <p>
                Každý, podle svých možností a touhy poznávat, si může zvolit
                trasu sobě na míru.
              </p>
